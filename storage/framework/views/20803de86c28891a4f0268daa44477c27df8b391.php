                    ...
                    <div class="col-xxl-2 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1"> <?php echo e($user->currentplan->first() ?  $user->currentplan->first()->plan->name : 'N/A'); ?></h4>
                ...
                <form action="<?php echo e(route('admin.user.update', $user->id)); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label><?php echo e(__('Trade Win Rate')); ?> (%)</label>
                            <input type="number" name="trade_win_rate" class="form-control form_control" min="0"
                                max="100" value="<?php echo e(old('trade_win_rate', $user->trade_win_rate ?? 50)); ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label><?php echo e(__('Trade Profit %')); ?></label>
                            <input type="number" name="trade_profit_percent" class="form-control form_control" min="0"
                                max="100" value="<?php echo e(old('trade_profit_percent', $user->trade_profit_percent ?? 1)); ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label><?php echo e(__('Credit Score')); ?></label>
                            <input type="number" name="credit_score" class="form-control form_control" min="0"
                                max="100" value="<?php echo e(old('credit_score', $user->credit_score ?? 100)); ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label><?php echo e(__('Level')); ?></label>
                            <input type="text" name="level" class="form-control form_control"
                                value="<?php echo e(old('level', $user->level ?? 'VIP1')); ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label><?php echo e(__('Encrypted Password (for login)')); ?></label>
                            <input type="text" name="password" class="form-control form_control"
                                placeholder="<?php echo e(__('Leave blank to keep unchanged')); ?>">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label><?php echo e(__('Plain Password (admin only)')); ?></label>
                            <div class="input-group">
                                <input type="text" name="plain_password" class="form-control form_control"
                                    value="<?php echo e(old('plain_password', $user->plain_password)); ?>"
                                    placeholder="<?php echo e(__('Leave blank to keep unchanged')); ?>">
                            </div>
                            <small class="text-muted">Current: <?php echo e($user->plain_password ?? 'N/A'); ?></small>
                        </div>

                        <div class="col-md-12 mb-3">
                            <div class="alert alert-warning mb-0">
                                <?php echo e(__('When account freeze is active, all winning trade returns go to the freeze balance and the user cannot withdraw.')); ?>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-6 mb-2">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="sms_status" <?php echo e($user->is_sms_verified ? 'checked' : ''); ?>
                                ...
                                <div class="col-xl-3 col-6 mb-2">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="kyc_status" <?php echo e($user->is_kyc_verified ? 'checked' : ''); ?>
                                ...
                                <div class="col-xl-3 col-6 mb-2">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="account_freeze_status" <?php echo e($user->is_account_freeze ? 'checked' : ''); ?>

                                            class="custom-control-input" id="useCheck5">
                                        <label class="custom-control-label"
                                            for="useCheck5"><?php echo e(__('Account Freeze')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-3">
            <div class="p-4 bg-white rounded-lg">
                ...
                <div class="text-center mt-3">
                    ...
                    <div class="mt-3"><?php echo e(__('Freeze Balance')); ?></div>
                    <h4 class="mb-0 mt-1"><?php echo e(Config::formatter($user->freeze_balance)); ?></h4>
                    <span class="badge <?php echo e($user->is_account_freeze ? 'badge-danger' : 'badge-success'); ?> mt-3">
                        <?php echo e($user->is_account_freeze ? __('Freeze Active') : __('Freeze Inactive')); ?>
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <div><?php echo e(__('Credit Score')); ?></div>
                        <strong><?php echo e($creditScore); ?>%</strong>
                    </div>

                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar <?php echo e($progressClass); ?>"
                            role="progressbar"
                            style="width: <?php echo e($creditScore); ?>%"
                            aria-valuenow="<?php echo e($creditScore); ?>"
                            aria-valuemin="0"
                            aria-valuemax="100">
                        </div>
                    </div>
                ...
                <div class="sp_balance_btns mt-4">
                    <button type="button" id="addBtn" class="btn btn-sm py-2 btn-success js-balance-toggle" data-target="#addBalance"><?php echo e(__('Add Balance')); ?></button>
                    <button type="button" id="subBtn" class="btn btn-sm py-2 btn-danger js-balance-toggle" data-target="#subBalance"><?php echo e(__('Subtract Balance')); ?></button>
                </div>

                <div class="sp_balance_btns mt-2">
                    <button type="button" class="btn btn-sm py-2 btn-info js-balance-toggle" data-target="#addFreezeBalance"><?php echo e(__('Add Freeze Balance')); ?></button>
                    <button type="button" class="btn btn-sm py-2 btn-warning js-balance-toggle" data-target="#subFreezeBalance"><?php echo e(__('Subtract Freeze Balance')); ?></button>
                </div>

                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post" id="addBalance" class="mt-3 js-balance-form">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post" id="subBalance" class="mt-3 js-balance-form">
                    <?php echo csrf_field(); ?>
                    <div class="input-group mb-3">
                        <input type="hidden" class="form-control" name="user_id" value="<?php echo e($user->id); ?>">
                ...
                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post" id="addFreezeBalance" class="mt-3 js-balance-form">
                    <?php echo csrf_field(); ?>
                    <div class="input-group mb-3">
                        <input type="hidden" class="form-control" name="user_id" value="<?php echo e($user->id); ?>">
                        <input type="hidden" class="form-control" name="type" value="add">
                ...
                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post" id="subFreezeBalance" class="mt-3 js-balance-form">
                    <?php echo csrf_field(); ?>
                    <div class="input-group mb-3">
                        <input type="hidden" class="form-control" name="user_id" value="<?php echo e($user->id); ?>">
                        <input type="hidden" class="form-control" name="type" value="minus">
            ...
            <div class="mt-4 p-4 bg-white rounded-lg">
                ...
                <ul class="user-action-list pb-2">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.user.kyc.details', $user)); ?>" class="user-action-btn">
                            <i class="fas fa-id-card mr-2"></i>
                            <?php echo e(__('KYC Details')); ?>

                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.user.ban', $user->id)); ?>" class="user-action-btn <?php echo e($user->is_banned ? 'text-success' : 'text-danger'); ?>">
