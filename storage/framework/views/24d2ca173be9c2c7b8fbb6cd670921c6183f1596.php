                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <p>
                                        <a data-route="<?php echo e(route('admin.manage.theme.update', 'default')); ?>" data-color="#9c0ac" class="<?php if(Config::config()->theme != 'default'): ?> btn btn-outline-danger btn-sm active-btn <?php endif; ?>  <?php if(Config::config()->theme == 'default'): ?> text-success <?php else: ?> text-danger <?php endif; ?> font-weight-bolder">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>
                                        <a data-route="<?php echo e(route('admin.manage.theme.update', 'light')); ?>" data-color="#F2062F" class="<?php if(Config::config()->theme != 'light'): ?> btn btn-outline-danger btn-sm active-btn <?php endif; ?>  <?php if(Config::config()->theme == 'light'): ?> text-success <?php else: ?> text-danger <?php endif; ?> font-weight-bolder" >
                            ...
                            <tr>
                                <td>
                                    <h5>
                                        ...
                                        <?php echo e(__('Blue Theme')); ?>

                                    </h5>
                                    <p>
                                        <a data-route="<?php echo e(route('admin.manage.theme.update', 'blue')); ?>" data-color="#0099FA" class="<?php if(Config::config()->theme != 'blue'): ?> btn btn-outline-danger btn-sm active-btn <?php endif; ?>  <?php if(Config::config()->theme == 'blue'): ?> text-success <?php else: ?> text-danger <?php endif; ?> font-weight-bolder">
                                            <?php if(Config::config()->theme == 'blue'): ?>
                                            <?php echo e(__('Activated')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laraval-trading-forex\resources\views/backend/setting/theme.blade.php ENDPATH**/ ?>