    ...
    <div class="account-page">
        <div class="form-wrapper">
            <div class="logo text-center">
                <a href="<?php echo e(route('home')); ?>" class="site-logo"><img src="<?php echo e(Config::getFile('dark_logo', Config::config()->dark_logo)); ?>"
                        alt="image"></a>
            </div>
...
<?php /**PATH C:\Users\p\Downloads\Compressed\signal_v5\main\resources\views/frontend/light/auth/master.blade.php ENDPATH**/ ?>