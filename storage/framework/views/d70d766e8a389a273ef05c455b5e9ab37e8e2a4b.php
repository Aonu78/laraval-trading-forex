                ...
                <div class="row g-sm-4 g-3">
                    ...
                    <div class="custom-xxl-6 col-xxl-3 col-xl-6 col-lg-3 col-6">
                        <div class="d-card d-icon-card">
                            ...
                            <div class="d-card-content">
                                <h4 class="d-card-amount"><?php echo e($totalSupportTickets); ?></h4>
                                <p class="d-card-caption"><?php echo e(__('Support Ticket')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form>
                                <div class="input-group">
                                    <input type="text" class="form-control copy-text2" placeholder="Referral link"
                                        value="<?php echo e(route('user.register', $user->username)); ?>" readonly>
                                    <button type="button" class="input-group-text sp_bg_base px-4 copy2"><?php echo e(__('Copy')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make(Config::theme() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\p\Downloads\Compressed\signal_v5\main\resources\views/frontend/blue/user/dashboard.blade.php ENDPATH**/ ?>