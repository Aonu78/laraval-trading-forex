        ...
        <div class="col-md-12">
            <div class="sp_site_card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <button id="new-ticket" class="btn sp_theme_btn btn-sm"><?php echo e(__('Create Ticket')); ?> <i class="fa fa-envelope ms-2" aria-hidden="true"></i></button>
                </div>
...
<?php echo $__env->make(Config::theme() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\p\Downloads\Compressed\signal_v5\main\resources\views/frontend/blue/user/ticket/list.blade.php ENDPATH**/ ?>