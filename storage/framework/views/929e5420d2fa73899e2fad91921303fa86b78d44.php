<form action="<?php echo e(route('admin.general.basic')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-4 col-xxl-12 col-lg-12 col-sm-12">
            <label for="exclusive_offer"><?php echo e(__('Exclusive Offer')); ?></label>
            <textarea name="exclusive_offer" class="form-control" rows="5"><?php echo e(Config::config()->exclusive_offer ?? ''); ?></textarea>
    ...
    <div class="row">
        <div class="mb-4 col-md-3 mb-3">
            ...
            <div id="image-preview" class="image-preview"
                style="background-image:url(<?php echo e(Config::getFile('logo', Config::config()->logo)); ?>);">
        ...
        <div class="mb-4 col-md-3 mb-3">
            ...
            <div id="image-preview-dark" class="image-preview"
                style="background-image:url(<?php echo e(Config::getFile('dark_logo', Config::config()->dark_logo)); ?>);">
        ...
        <div class="mb-4 col-md-3 mb-3">
            ...
            <div id="image-preview-icon" class="image-preview"
                style="background-image:url(<?php echo e(Config::getFile('icon', Config::config()->favicon)); ?>);">
...
<?php /**PATH C:\Users\p\Downloads\Compressed\signal_v5\main\resources\views/backend/setting/general_setting.blade.php ENDPATH**/ ?>